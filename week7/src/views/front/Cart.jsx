...
const Cart = () => {
  ...
  const confirmClearCart = async () => {
    const swalWithBootstrapButtons = MySwal.mixin({
      customClass: {
        confirmButton: 'btn btn-success py-2 px-3',
        cancelButton: 'btn btn-danger py-2 px-3 me-3',
      },
      buttonsStyling: false,
    });
    const result = await swalWithBootstrapButtons.fire({
      title: '清空購物車?',
      text: '將會清空購物車內的所有商品，請確認是否要繼續。',
      icon: 'warning',
      ...
      preConfirm: async () => {
        try {
          ...
          Swal.showValidationMessage(error.response?.data?.message || '清空失敗');
          return false;
        }
      },
      ...
      <div className="row g-5">
        <div className="col-lg-8">
          ...
          {isLoading ? (
            ...
            >
              <Loading />
              <MoonLoader color="#48bae5" loading size={120} speedMultiplier={0.5} />
                ...
                <div key={item.id} className="glass-card p-3">
                  <div className="row align-items-center">
                    ...
                    <div className="col-md-4">
                      ...
                      <p
                        className="mx-auto text-secondary small mb-0"
                        style={{
                          width: '200px',
            ...
            <div className="glass-card text-center py-5">
              ...
              <Link to="/product" className="btn btn-aurora">
                立即選購
              </Link>
            </div>
          )}
        ...
        <div className="col-lg-4">
          <div className="glass-card sticky-top" style={{ top: '100px' }}>
            ...
            <button
              className={showOrderForm ? 'd-none' : 'btn btn-aurora w-100 py-3 fw-bold'}
              type="button"
            ...
            {showOrderForm && (
              <OrderForm onOrderCreated={handleOrderCreated} cartItems={cartItems} />
            )}
